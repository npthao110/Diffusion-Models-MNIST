# -*- coding: utf-8 -*-
"""
Minimal DDPM on MNIST (improved v3):
✅ x0 clamp during sampling (stability / fewer artifacts)
✅ EMA weights for cleaner samples (standard diffusion trick)
✅ Improved DDIM sampling (clean timestep schedule + more stable update)
✅ Saves ablation grids into an output folder

Run:
  python source_code_updated_v3.py
"""
...
def main():
    ...
    # Training hyperparams (same as your v2 runs)
    T = 1000
    epochs = 120
    batch_size = 128
    lr = 2e-4

    # Save into a project-local ./output folder by default
